              ...
              <tbody>
                {cart.map(item => (
                  <tr key={item.id} className="align-middle">
                    ...
                    <td className="font-semibold text-neutral-900 text-center sm:text-left sm:align-middle align-top sm:py-0 py-2 sm:mb-0 mb-3 pr-10 sm:pr-0">
                    ...
                    <td className="sm:align-middle align-top sm:py-0 py-2 sm:mb-0 mb-3">
                      <div className="block sm:inline mb-2 sm:mb-0">
                        <div className="flex items-center border rounded w-fit mx-auto relative z-10 bg-white sm:mr-0 mr-6" style={{ borderColor: '#4E1F00' }}>
